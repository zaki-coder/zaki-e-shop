          ...
          <div className="h-full w-10/12 flex justify-between">
            ...
            <div className="flex-1 flex flex-col gap-8">
              ...
              <p className="text-[20px] text-[#333]">
                Description:{" "}
                <span className="text-orange-500 text-ellipsis">
                  {product?.desc}
                </span>
              </p>
              <div className="flex gap-6 items-center">
                <span className="bg-slate-300 px-4 py-2 text-[18px]">-</span>
                <span>{quantity}</span>
                <span className="bg-slate-300 px-4 py-2 text-[18px]">+</span>
              </div>
              <span className="text-[20px] text-[#333]">Price: <span className="text-orange-500 ml-2">${product?.price}</span></span>
              <button className="mt-auto py-2 px-5 rounded-lg flex items-center gap-4 bg-orange-400 text-[#efefef] max-w-max hover:bg-orange-500 transition-all">
